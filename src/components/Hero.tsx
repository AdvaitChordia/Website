  ...
  return (
    <div className="h-screen flex flex-col justify-center items-center relative overflow-hidden">
      ...
      <div className="z-10 text-center px-4 max-w-5xl mx-auto w-full">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-normal tracking-tight mb-6 text-foreground">
            Hi, I'm {resumeData.personal.name}
          </h2>
        </motion.div>

        {/* Title - Styled like previous Portfolio tag */}
        <motion.div
        ...
        >
          <a
            href="#projects"
            className="group relative px-8 py-3 bg-primary text-primary-foreground font-medium rounded-sm border border-primary hover:bg-transparent hover:text-primary transition-all duration-300"
          >
