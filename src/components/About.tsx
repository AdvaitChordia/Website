    ...
    return (
        <Section id="about" className="pt-20 pb-20">
            <div className="max-w-4xl mx-auto px-4">
                ...
                >
                    <p className="text-muted-foreground text-base leading-normal mb-4 font-light text-justify">
                    ...
                    <p className="text-muted-foreground text-base leading-normal font-light text-justify">
